...
[
	...
	["<t color='#B80000'>Register Ownership</t>", "addons\Conlegium\changeowner.sqf", [], 51, false, false, "", "(['OwnOffice_1', getpos player] call BIS_fnc_inTrigger || ['OwnOffice_2', getpos player] call BIS_fnc_inTrigger || ['OwnOffice_3', getpos player] call BIS_fnc_inTrigger) && !(vehicle player == player) && ((vehicle player) isKindOf 'Air' ||( vehicle player) isKindOf 'LandVehicle' || (vehicle player) isKindOf 'Ship')"],
