...
A3W_fnc_VehSecureStatus = { (objectFromNetId (_this select 0)) lock (_this select 1) } call mf_compile;
A3W_fnc_VehBulproofStatus = { (objectFromNetId (_this select 0)) allowDamage (_this select 1) } call mf_compile;
