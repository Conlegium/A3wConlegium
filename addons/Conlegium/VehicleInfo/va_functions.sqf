...
va_outside_add_actions = {
  ...
  _action_id = player addaction [format["<img image='addons\Conlegium\VehicleInfo\icons\info.paa'/> %1 info", _display_name], {_this call va_information_action;}, [_player, _vehicle],-90,false,false,"",
