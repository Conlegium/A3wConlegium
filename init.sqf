...
if (!isDedicated) then
{
	[] spawn
	{
		...
		{
			9999 cutText ["Welcome to A3wConlegium, please wait for your client to initialize", "BLACK", 0.01];
...
if (hasInterface || isServer) then
{
	...
	[] execVM "addons\Conlegium\VehicleInfo\init_VehInfo.sqf"; // Vehicle Information
};
